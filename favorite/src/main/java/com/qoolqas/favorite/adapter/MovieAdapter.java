...
import com.qoolqas.favorite.activity.DetailMovie;
...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.ViewHolderMovie> {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        Movie clickedItem = Item(position);
    ...
    public void onBindViewHolder(@NonNull ViewHolderMovie holder, final int position) {
        final Movie movie = Item(position);
        holder.title.setText(movie.getTitle());
        holder.release.setText(movie.getReleaseDate());
        holder.rating.setText(String.valueOf(movie.getVoteAverage()));

        Glide.with(mContext).load("https://image.tmdb.org/t/p/w185" + movie.getPosterPath()).into(holder.imageView);
    }
