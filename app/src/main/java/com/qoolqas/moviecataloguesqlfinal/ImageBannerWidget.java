...
public class ImageBannerWidget extends AppWidgetProvider {
    private static final String TOAST_ACTION = "com.qoolqas.moviecataloguesqlfinal.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.qoolqas.moviecataloguesqlfinal.EXTRA_ITEM";
